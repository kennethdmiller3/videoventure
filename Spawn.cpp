...
{
	if (const char *ordnance = element->Attribute("name"))
		mSpawn = Hash(ordnance);
...
unsigned int SpawnTemplate::Instantiate(unsigned int aId, const Transform2 &aPosition, const Transform2 &aVelocity)
{
